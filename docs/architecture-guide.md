...
│  ┌──────────────┐  ┌──────────────┐  ┌───────────────────────────┐  │
│  │ Cloud Backend │  │ Fast Connectors│ │  75 Airline Connectors    │  │
...
**This means:** If 10 out of 75 connectors fail (timeouts, bot detection, API errors), you still get results from the other 65. The search never fails completely unless *every* source fails.
...
# INFO: Route filter: LHR->BCN -- skipped 55/75 irrelevant connectors
